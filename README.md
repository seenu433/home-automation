...
> __💡 Note__: All application settings (including `AuthKey` and `VoiceMonkey__Token` for door-fn) are automatically configured by the Bicep deployment using these parameters.
